...
<head>
    ...
    <title>Dental Admin Account</title>
</head>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text2 card-title">Admin Account Settings</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    <div class="con1">
                                        ...
                                        <div>
                                            <i>Email Address:</i>
                                            <p class="text1"><?php echo $row["email"]; ?></p>
                                            <i>Contact Number:</i>
                                            <p class="text1"><?php echo $row["contact"]; ?></p>
                                            <i>Address:</i>
                                            <p class="text1"><?php echo $row["address"]; ?></p> <br>
                                        </div>
